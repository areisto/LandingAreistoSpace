  ...
  <div class="container">
    <div class="d-flex align-items-center justify-content-between gap-2">
      ...
      <div class="d-flex align-items-center gap-2">
        <a href="https://workspace.areistospace.com/login" class="secondary-cstm-button d-none d-sm-block">تسجيل دخول</a>
        <a href="https://workspace.areistospace.com/register" class="primary-cstm-button d-none d-sm-block">ابدأ مجانا</a>
